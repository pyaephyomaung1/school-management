...
import { getTeacherById, updateTeacher } from "@/lib/api/teacher";
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center text-red-600">
          <h2 className="text-2xl font-semibold">Error: Invalid Teacher ID</h2>
          <p>The provided teacher ID is invalid. Please check the URL and try again.</p>
        </div>
      </div>
    );
  }
    ...
    const loadData = async () => {
      try {
        ...
        if (teacherData.teacherImage) {
          setImagePreview(teacherData.teacherImage);
        }
      } catch (error) {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        ...
        <p className="text-lg font-semibold text-gray-700">Loading teacher data...</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex justify-center items-center py-12 px-4">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Edit Teacher</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setTeacher({ ...teacher, department: Number(e.target.value) })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  required
                >
